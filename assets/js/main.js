! function(e) {
    ...
    if (e(window).on("load", (function() {
            ...
            return this.each((function() {
                ...
                var a = "." + s.thSubMenuParent + " > a";
                e(a).each((function() {
                    e(this).on("click", (function(t) {
                        var n, a;
                        t.preventDefault(), n = e(this).parent(), (a = n.children("ul")).length > 0 && (n.toggleClass(s.subMenuParentToggle), a.slideToggle(s.toggleSpeed), a.toggleClass(s.subMenuToggleClass))
                    }))
        ...
        var s = document.querySelector(".scroll-top"),
            ...
            a = n.getTotalLength();
        n.style.transition = n.style.WebkitTransition = "none", n.style.strokeDasharray = a + " " + a, n.style.strokeDashoffset = a, n.getBoundingClientRect(), n.style.transition = n.style.WebkitTransition = "stroke-dashoffset 10ms linear";
        var i = function() {
    ...
    e("[data-bg-src]").length > 0 && e("[data-bg-src]").each((function() {
        ...
        e("[data-slick-next]").each((function() {
            ...
            prevArrow: s("prev-arrow") ? n : '<button type="button" class="slick-prev"><i class="fa-solid fa-arrow-left"></i></button>',
            nextArrow: s("next-arrow") ? a : '<button type="button" class="slick-next"><i class="fa-solid fa-arrow-right"></i></button>',
    ...
    var o = e(".hero-slider-6"),
        r = e(".progress"),
        l = e(".pagingInfo1"),
        c = e(".slider__label"),
        d = e(".pagingInfo2");
    o.on("init reInit afterChange", (function(e, t, s, n) {
        if (t.$dots) {
            var a = (s || 0) + 0;
            l.text(a + 1), d.text(t.slideCount)
        }
    })), o.on("beforeChange", (function(e, t, s, n) {
        var a = n / (t.slideCount - 1) * 100;
        r.css("background-size", a + "% 100%").attr("aria-valuenow", a), c.text(a + "% completed")
    }));
    var u = e(".slick-3d-active");
    u.on("init", (function(t, s, n) {
        var a = e(s.$slides[s.currentSlide]),
            i = a.next(),
            o = a.next().next(),
            r = a.prev(),
            l = a.prev().prev();
        r.addClass("slick-3d-prev"), i.addClass("slick-3d-next"), l.addClass("slick-3d-prev2"), o.addClass("slick-3d-next2"), a.removeClass("slick-3d-next").removeClass("slick-3d-prev").removeClass("slick-3d-next2").removeClass("slick-3d-prev2"), s.$prev = r, s.$next = i
    })).on("beforeChange", (function(t, s, n, a) {
        var i = e(s.$slides[a]);
    ...
    o = e(".heroSlider"), r = e(".progress"), l = e(".pagingInfo1"), c = e(".slider__label"), d = e(".pagingInfo2");
    o.on("init reInit afterChange", (function(e, t, s, n) {
        if (t.$dots) {
            var a = (s || 0) + 0;
            l.text(a + 1), d.text(t.slideCount)
    ...
    })), e(".th-carousel").on("afterChange", (function(t, s, n, a) {
        e(s.$slides).find("[data-ani]").removeClass("th-animated"), e(s.$slides[n]).find("[data-ani]").addClass("th-animated")
    }));
    ...
    function b() {
        ...
        (function() {
            ...
            function n(n) {
                n = n.split(",");
                for (var a = 0; a < n.length; a++) t = v + " " + n[a], e(t).val() ? (e(t).removeClass("is-invalid"), s = !0) : (e(t).addClass("is-invalid"), s = !1)
            }
            n('[name="name"],[name="email"],[name="subject"],[name="number"],[name="message"]'), e(g).val() && e(g).val().match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/) ? (e(g).removeClass("is-invalid"), s = !0) : (e(g).addClass("is-invalid"), s = !1);
            return s
        })() && jQuery.ajax({
            url: e(v).attr("action"),
            data: t,
    ...
    function k(t, s, n, a) {
        var i = t.text().split(s),
            o = "";
        i.length && (e(i).each((function(e, t) {
            o += '<span class="' + n + (e + 1) + '">' + t + "</span>" + a
        })), t.empty().append(o))
    }
    ...
    e.fn.lettering = function(t) {
        ...
        e(this).each((function() {
            var n, a, i, o, r, l = e(this);
            n = Math.floor(l.height() / 2), a = l.attr(t), i = l.attr(s), o = y(e(i).css("padding-top")), r = y(e(i).css("padding-bottom")), "top-half" === a ? (e(i).css("padding-bottom", r + n + "px"), l.css("margin-top", "-" + n + "px")) : "bottom-half" === a && (e(i).css("padding-top", o + n + "px"), l.css("margin-bottom", "-" + n + "px"))
        }))
    };
    ...
    (new WOW).init(), e.fn.asTab = function(t) {
        ...
        e(this).each((function() {
            var t = e(this),
                n = t.find(s.tabButton);
            t.append('<span class="indicator"></span>');
            var a = t.find(".indicator");
            if (n.on("click", (function(t) {
                    t.preventDefault();
                    var n = e(this);
                    n.addClass("active").siblings().removeClass("active"), s.sliderTab ? e(i).slick("slickGoTo", n.data("slide-go-to")) : r()
                })), s.sliderTab) {
                var i = t.data("asnavfor"),
                    o = 0;
                n.each((function() {
                    var n = e(this);
                    n.attr("data-slide-go-to", o), o++, n.hasClass("active") && e(i).slick("slickGoTo", n.data("slide-go-to")), e(i).on("beforeChange", (function(e, n, a, i) {
            ...
            function r() {
                ...
                a.get(0).style.setProperty("--height-set", o), a.get(0).style.setProperty("--width-set", r), a.get(0).style.setProperty("--pos-y", l), a.get(0).style.setProperty("--pos-x", c), e(n).first().position().left == i.position().left ? a.addClass("start").removeClass("center").removeClass("end") : e(n).last().position().left == i.position().left ? a.addClass("end").removeClass("center").removeClass("start") : a.addClass("center").removeClass("start").removeClass("end")
            }
            r()
        }))
        ...
        e(this).each((function() {
            ...
            if (n.on("click", (function(t) {
                    t.preventDefault();
                    var n = e(this);
                    n.addClass("active").siblings().removeClass("active"), s.sliderTab && e(a).slick("slickGoTo", n.data("slide-go-to"))
                })), s.sliderTab) {
                var a = t.data("asnavfor"),
                    i = 0;
                n.each((function() {
                    var n = e(this);
                    n.attr("data-slide-go-to", i), i++, n.hasClass("active") && e(a).slick("slickGoTo", n.data("slide-go-to")), e(a).on("beforeChange", (function(e, n, a, i) {
                        t.find(s.tabButton + '[data-slide-go-to="' + i + '"]').addClass("active").siblings().removeClass("active")
                    }))
                }))
            }
        }))
        ...
        e(this).each((function() {
            ...
            var a = setInterval((function() {
                ...
                o < 10 && (o = "0" + o), r < 10 && (r = "0" + r), l < 10 && (l = "0" + l), c < 10 && (c = "0" + c), i < 0 ? (clearInterval(a), t.addClass("expired"), t.find(".message").css("display", "block")) : (n(".day").html(o), n(".hour").html(r), n(".minute").html(l), n(".seconds").html(c))
            }), 1e3)
        }))
        ...
        function o() {
            ...
            })), a.get(0).style.setProperty("--height-set", n), a.get(0).style.setProperty("--width-set", i), a.get(0).style.setProperty("--pos-y", o), a.get(0).style.setProperty("--pos-x", r)
        }
